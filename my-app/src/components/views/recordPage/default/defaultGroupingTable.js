  ...
  return (
    <div ref={resultRef} style={{ minHeight: "100vh", padding: "10px", backgroundImage: `url(${chartpage})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      <div style={{ marginBottom: "20px", textAlign: "center" }}>
        <h1 style={{ marginBottom: "10px", color: "#fff", fontSize: "25px" }}>🏆투표자 랭킹🏆</h1>
        <p style={{ fontSize: '11px', color: "#fff" }}>💡{date.toLocaleDateString()} 투표자 랭킹입니다.</p>
        <p style={{ fontSize: '10px', color: "#fff" }}>💡순위의 기준은 하루당 평균 승점입니다.</p>
        <p style={{ fontSize: '10px', color: "#fff" }}>💡상위 랭킹부터 내림차순으로 랜덤으로 팀이 배정됩니다.</p>
        {/* <Search
