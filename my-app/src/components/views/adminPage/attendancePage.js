...
function AttendancePage() {
    const all = [
        ...
        { id: 10, name: "김상명", image: profile1, num: 52 }, { id: 11, name: "신종윤", image: profile1, num: 13 }, { id: 12, name: "임필우", image: profile1, num: 19 }, { id: 13, name: "이병철", image: profile1, num: 11 }, { id: 14, name: "황성진", image: profile1, num: 10 },
        ...
        { id: 20, name: "정기택", image: profile2, num: 2 }, { id: 21, name: "김정민", image: profile2, num: 7 }, { id: 22, name: "정현준", image: profile3, num: 15 }, { id: 23, name: "김주환", image: profile2, num: 5 }, { id: 24, name: "이지철", image: profile2, num: 9 }, 
        ...
        { id: 35, name: "민준홍", image: profile3, num: 35 }, { id: 36, name: "이성혁", image: profile3, num: 10 }, { id: 37, name: "이   정", image: profile3, num: 11 }, { id: 38, name: "이상욱", image: profile3, num: '00' }, { id: 39, name: "박준영", image: profile3, num: 27 },
