...
function AttendancePage() {
    const all = [
        ...
        { id: 35, name: "이상욱", image: profile3, num: '00' }, { id: 36, name: "박준영", image: profile3, num: 27 }, { id: 37, name: "윤한중", image: profile3, num: 12 }, { id: 38, name: "황성진", image: profile3, num: 10 }, { id: 39, name: "정현준", image: profile3, num: 15 }, 
        { id: 40, name: "정도식", image: profile3, num: 10 }
    ];
